...
/**
 * Created by leiwei on 2020/4/7 17:19
 */
public class RestTemplateUtils {
    ...
    */
     ...
     * @return ResponseEntity 响应对象封装类
     */
    private static <T> ResponseEntity<T> post(String url, HttpHeaders headers, Object requestBody, Class<T> responseType, Object... uriVariables) {
     ...
     * @return ResponseEntity 响应对象封装类
     */
    private static <T> ResponseEntity<T> post(String url, HttpHeaders headers, Object requestBody, Class<T> responseType, Map<String, ?> uriVariables) {
        HttpEntity<Object> requestEntity = new HttpEntity<Object>(requestBody, headers);
        return post(url, requestEntity, responseType, uriVariables);
    }
     ...
     * @return ResponseEntity 响应对象封装类
     */
    private static <T> ResponseEntity<T> post(String url, HttpEntity<?> requestEntity, Class<T> responseType, Object... uriVariables) {
